...
if (isset($_POST['add']))
	...
	include 'db.php';
		 ...
		 mysqli_query($conn,"INSERT INTO  consumer (id,firstname,lastname,username,address,contact_number) 
		 VALUES ('$id','$lname','$fname','$mi','$address','$contact')"); 
...
if (isset($_POST['add']))
	...
	include 'db.php';
		 ...
		 mysqli_query($conn,"INSERT INTO  users (id,firstname,lastname,username,address,can) 
		 VALUES ('$id','$lname','$fname','$mi','$address','$contact')"); 
				
				echo '<script>alert("GGALING")</script>';

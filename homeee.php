...
<body>
				  ...
				  <?=esc($row['firstname'])?>  <?=esc($row['lastname'])?>
					  ...
					  <ul>
						  <li>
							  ...
							  <a href="../Prototype/user.html">My Profile</a>
						  </li>
						  <li>
  ...
  <img src="../images/pfp.png" alt="" width="90" height="90" class="rounded-circle" id="image1" ></div>
...
<br>
<div class="uplangnatin">
<h4 id="tad">TOTAL AMOUNT DUE:</h4>
<br>
<h1 id="tadprice"> <b> ₱ 534.00 </b></h1>
<br>
<h5 id="h5due">DUE DATE: </h5> 
<h5 id="h5due_num">2022-12-06</h5>
<button type="button" id="btnpay" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Pay Now</button>

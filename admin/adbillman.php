                        ...
                        <?php
                            ...
                            while($row=mysqli_fetch_array($result)){
                                ...
                                <td><?php echo $row['user_id']; ?></td>
									...
									<td>
									<a href=" paybill.php?id=<?php echo $row['user_id']; ?>">
                                            <button class="edit"  id="update-show">
                                                <span class='front icon'><i class='bx bx-receipt' ></i></span>
                                            </button>
                                        </a>
                                        <a href=" viewbill.php?id=<?php echo $row['user_id']; ?>">
                                            <button class="edit"  id="update-show">
                                                <span class='front icon'><i class='bx bx-low-vision bx-flip-vertical bx-burst' ></i></i></span>
                                            </button>
                                        </a>

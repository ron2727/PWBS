...
<head>
	...
	<!-- My CSS -->
	<link rel="stylesheet" href="./css/adbill.css">
...
<body>
	...
	<section id="sidebar">
		<a href="#" class="brand">
			<img src="../images/Logo.png " style="height:60px;width:60px;" alt="" id="logo" >
			&nbsp;	&nbsp;	&nbsp;	&nbsp;
...
<br />
  ...
  <div class="head-title">
		...
		<h1 id="biltitle" >Billing</h1>
			...
			<link rel="stylesheet" href="./css/adbill.css">
		<form action="" method="post" id="moveee">
				<div class="form-input">
...
?>
	  <br><br>
                <table class="content-table" id="table-data" style="width: 1100px;">
                    <thead >
                        <th class="col" style="background-color:#3A86FF">Id</th>
                        <th class="col" style="background-color:#3A86FF">Lastname</th>
                        <th class="col" style="background-color:#3A86FF">Firstname</th>
                        <th class="col" style="background-color:#3A86FF">Email</th>
                        <th class="col" style="background-color:#3A86FF">Can </th>
						<th class="col" style="background-color:#3A86FF">Status</th>
                        <th class="col" style="background-color:#3A86FF">Operator</th>
                    </thead>
                        ...
                        <?php
                            ...
                            while($row=mysqli_fetch_array($result)){
                                ...
                                <tr>
									...
									<td class="col"><?php echo $row['unique_id']; ?></td>
                                    <td class="col"><?php echo $row['status']; ?></td>
                                    
                                    
                                    <td>
                                     
                                    <a rel='facebox' href="wpaybill.php?id=<?php echo $row['user_id']; ?>">
                                            <button class="edit">
                                                <span class='front icon' ><i class="bi bi-receipt"></i></span>
                                            </button>
                                        </a>
                                        <a rel='facebox' href="viewbillw.php?id=<?php echo $row['user_id']; ?>">

...
<head>
    ...
    <body>
        ...
        <section class="admins">
            <button class="add" id="add-show" style="width: 180px" >
                    <span class='shadow_add'></span>
                    <span class='edge_add'></span>
                    <span class='front_add icon'> Add New Consumer<i class='bx bxs-user-plus'></i></span>
            </button>
  ...
  <div class="wrapper">
    <section class="form signup">
      ...
      <form action="#" method="POST" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="field input">
            <label>Last Name</label>
            <input type="text" name="address" placeholder="Last name" required>
          </div>
        </div>
        <div class="field input">

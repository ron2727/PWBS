...
<body>
	...
	include('db.php');
	$id=$_GET['id'];
	$query=mysqli_query($conn,"select * from `users1` where user_id='$id'");
            ...
            <div class="col-md-8">
                ...
                <div class="card mt-5" style="width : 800px; height:800px;">
                    ...
                    <div class="card-body" style="width : 800px;">
                        ...
                        <form  method="POST" action="uupdate.php?user_id=<?php echo $id; ?>" style="width : 700px;">
							...
							<div class="form-group mb-3">
                                ...
                                <input type="text"   value="<?php echo $row['address']?>" name="address" class="form-control" s>
                            </div>
                            <div class="form-group mb-3">
                                <label for="">Email</label>
                                <input type="text"   value="<?php echo $row['email']?>" name="email" class="form-control" s>
                            </div>
						
                            <div class="form-group mb-3">
                                <label for="">Phone</label>
                                <input type="text"   value="<?php echo $row['phone']?>" name="phone" class="form-control" s>
                            </div>
						
      <!-- Username -->
    
                        <label style="margin-left:1rem;"> Status</label>
						&nbsp;	<select name="status"  value="<?php echo $row['status']; ?>"  class="form-control my-2" style="margin-left:1rem; width:40rem;">

...
<script src="//code.jquery.com/jquery-1.11.1.min.js"></script>
  ...
  <fieldset>
	...
	<div class="control-group">
      ...
      <div class="controls">
        <input type="text" id="username"  value="<?php echo $row['id']; ?>" name="id" placeholder="" class="input-xlarge">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="text" id="username"  value="<?php echo $row['firstname']; ?>" name="firstname" placeholder="" class="input-xlarge">
	...
	<div class="control-group">
      ...
      <div class="controls">
        <input type="text" id="username"  value="<?php echo $row['surname']; ?>" name="surname" placeholder="" class="input-xlarge">
	...
	<label>Select Role</label>
						<select name="role"  value="<?php echo $row['role']; ?>"  class="form-control my-2">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <input type="password" id="password" value="<?php echo $row['password']; ?>" name="pass" placeholder="" class="input-xlarge">

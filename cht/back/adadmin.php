...
<head>
    ...
    <body>
        ...
        <button class="cssbuttons-io-button" id="register-show" style="background-color:#3A86FF; width: 190px;">
        ...
        <div id="register-modal-form" >
                <div class="modal-form">
                    ...
                    <div class ="register-form">
                        ...
                        <form method="post">
                            <input placeholder="Enter First Name" type="text" name="fname" class="input">
                            <input placeholder="Enter Last Name" type="text" name="sname" class="input">
                            <input placeholder="Enter Username" type="text" name="uname" class="input">
...
<br>
                            <input placeholder="Enter Password" type="password" name="pass" class="input">
                            <input placeholder="Confirm Password" type="password" name="c_pass" class="input">
                    

                            <button type="submit" name="register" class ="submit-btn-1">Add</button>
                        </form>
                    </div>
                </div>
            </div>
